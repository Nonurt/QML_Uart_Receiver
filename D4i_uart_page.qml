    ...
    Rectangle {
        ...
        Row {
            ...
            Rectangle {
                ...
                // Opacity animasyonu (parlaklık efekti)
                Behavior on opacity {
                    NumberAnimation {
                        duration: 1000
                ...
                // Sadece bağlıysa animasyon olsun
...
/*##^##
Designer {
    D{i:0}D{i:5;locked:true}D{i:7;locked:true}D{i:10;locked:true}D{i:13;locked:true}D{i:16;locked:true}
D{i:19;locked:true}D{i:22;locked:true}D{i:25;locked:true}D{i:28;locked:true}D{i:31;locked:true}
D{i:47}
}
##^##*/
